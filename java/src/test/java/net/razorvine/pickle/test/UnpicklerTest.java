...
public class UnpicklerTest {
	...
	@Test
	public void testUnpicklerNoMapReuse() throws PickleException, IOException
	{
        ...
        for (byte[] bytes : array) {
            ...
            while (iter1.hasNext()) {
                ...
                // results from a reused Unpickler should be the same as the Unpickler that closes after each unpickling.
