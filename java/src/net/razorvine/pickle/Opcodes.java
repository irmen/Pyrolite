...
public interface Opcodes {
	...
	static short  BINPERSID = 'Q'; // "       " "  ;  " "   " " stack
	...
	static short  SHORT_BINSTRING = 'U'; // "     " ; "      " "      " < 256 bytes
	static short  UNICODE = 'V'; // push Unicode string; raw-unicode-escaped'd argument
	static short  BINUNICODE = 'X'; // "     " " ; counted UTF-8 string argument
	...
	static short  BINGET = 'h'; // "    " "    " "   " ; "    " 1-byte arg
	...
	static short  BINPUT = 'q'; // "     " "   " " ;   " " 1-byte arg
	static short  LONG_BINPUT = 'r'; // "     " "   " " ;   " " 4-byte arg
